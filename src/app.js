...
app.get(
  "/admin/registrationRequestDetails/:id",
  AdminProtect,
  getPharmRegistrationReqDetails
);
...
app.post("/pharmacist/addMedicine", PharmacistProtect, addMedicine),
  ...
  app.get(
    "/pharmacist/getMedicineQuantitySales/:id",
    PharmacistProtect,
    getMedicineQuantitySales
  );
...
app.get(
  "/medicine/viewActiveMedicines",
  PharmacistProtect || PatientProtect || AdminProtect,
  getActiveMedicines
);

app.get(
  "/medicine/searchForMedicine",
  PharmacistProtect || PatientProtect || AdminProtect,
  searchForMedicine
);
app.post(
  "/medicine/filterMedicineByMedicinalUse",
  PharmacistProtect || PatientProtect || AdminProtect,
  filterMedicineByMedicinalUse
);

app.get(
  "/medicine/viewAlternatives/:medicineId",
  PatientProtect,
  viewAlternatives
);
//-----------------Cart Endpoints---------------------
